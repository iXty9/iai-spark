...
type ThemeContextType = {
  ...
  defaultThemeSettings: ThemeSettings | null;
};
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ 
  ...
  const applyThemeMode = useCallback((newTheme: 'light' | 'dark') => {
  ...
  useEffect(() => {
    ...
    logger.info('Initializing theme settings from ThemeContext', { module: 'theme' });
